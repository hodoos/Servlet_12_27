...
%>
	...
	<div class="container">
		<header class="text-danger text-center">SK broadband IPTV</header>
		<nav class="main-menu">
		...
		<section class="bg-danger content"></section>
		<footer class="text-center">Copyright 2023. jongho All Rights Reserved</footer>
